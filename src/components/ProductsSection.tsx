  ...
  <section id="cellular-lab" className="py-24 md:py-36">
    <div className="container mx-auto px-4">
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
        <p className="text-xs tracking-[0.3em] uppercase text-gold mb-4 font-body font-medium">Cellular Lab</p>
        <h2 className="font-display text-3xl md:text-5xl font-light text-foreground leading-tight">
          Catálogo <span className="gold-text font-medium">Individual</span>
        </h2>
